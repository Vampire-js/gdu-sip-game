...
const paths = DOMAIN_ROUTES.map((route) => `<path d="${routePath(route)}"/>`).join('\n');
const newIslands = DOMAIN_ISLANDS.map(({ x, z, radius }) =>
...
console.log('Generated seven-domain grass mask and connected bowling island.');